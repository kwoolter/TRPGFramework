...
class MapLink:
    ...
    def __str__(self):
        link_description = "Go " + self.direction + " from " + str(self.from_id) + " " + self.description + " to " + str(self.to_id) +"."
...
class LevelMap:
    ...
    def lock(self, location_id, direction, is_locked):
        ...
        # else the specified link could not be found to lock it
            ...
            logging.warning("Lock(" + str(is_locked) + "): No link found " + direction + " from location " + str(location_id))
